...
class AttributeFilter:
    ...
    def __repr__(self):
        """Return a program-inpretable representation of the class."""
        return f"{self.__class__.__name__}(op=operator.{self.op.__name__}, value={self.value})"


class DateFilter(AttributeFilter):
    """Representation of a date filter."""
...
class DistanceFilter(AttributeFilter):
    """Representation of a distance filter."""
...
class VelocityFilter(AttributeFilter):
    """Representation of a velocity filter."""
...
class DiameterFilter(AttributeFilter):
    """Representation of a diameter filter."""
...
class HazardousFilter(AttributeFilter):
    """Representation of a hazardous filter."""
...
def create_filters(date=None, start_date=None, end_date=None,
                   ...
                   hazardous=None):
    """Filter criteria assembler method."""
    filters = set()
    if date is not None:
...
def limit(iterator, n=None):
    ...
    if n == 0:
        n = None
    iter = ()
    for i in itertools.islice(iterator, n):
        iter = iter + (i,)
    return iter
