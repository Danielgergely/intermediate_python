...
if __name__ == '__main__':
    ...
    # cads = load_approaches('tests/test-cad-2020-Test.json')
    # database = NEODatabase(neos, cads)
    # date_from = date_fromisoformat('2020-01-01')
    # date_to = date_fromisoformat('2020-12-31')
    # filters = create_filters(start_date=date_from, end_date=date_to)
    # result = database.query(filters)
    # # write_to_csv(result, "test.csv")
    # write_to_json(result, "test.json")
    # a = 10